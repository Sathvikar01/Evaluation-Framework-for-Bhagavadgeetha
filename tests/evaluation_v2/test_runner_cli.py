...
class MockPipeline:
    ...
    def query(self, query, **kwargs):
        ...
        return {"reranked_results": [{"chunk_type": "verse", "verse_ref": "BhG 2.47", "chunk_id": "x"}], "intermediate": {"vector_results": [{"verse_ref": "BhG 2.47"}], "graph_results": [], "bm25_results": [], "fused_results": [{"verse_ref": "BhG 2.47"}], "reranked_results": [{"verse_ref": "BhG 2.47"}]}}
